...
optS_npvmax, x_final_npvmax, v_final_npvmax, L_final_npvmax, C_final_npvmax, B_final_npvmax, accumulated_npv_npvmax, strategy_npvmax = solve_cutler_et_al_ddp(pars, initial_state)
